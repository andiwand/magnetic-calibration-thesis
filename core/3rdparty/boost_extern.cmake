# take from https://github.com/pfultz2/cget/blob/master/cget/cmake/boost.cmake
...
macro(preamble PREFIX)
    ...
    if(CMAKE_C_COMPILER_TARGET)
        set(${PREFIX}_C_FLAGS "-target ${CMAKE_C_COMPILER_TARGET} ${${PREFIX}_C_FLAGS}")
    endif()
    if(CMAKE_CXX_COMPILER_TARGET)
        set(${PREFIX}_CXX_FLAGS "-target ${CMAKE_CXX_COMPILER_TARGET} ${${PREFIX}_CXX_FLAGS}")
    endif()
...
set(B2_TOOLCHAIN_VERSION android)
set(B2_CONFIG ${CMAKE_CURRENT_BINARY_DIR}/user-config.jam)

set(B2_CONFIG_CONTENT "
using ${BOOST_TOOLCHAIN} : ${B2_TOOLCHAIN_VERSION} : \"${CMAKE_CXX_COMPILER}\" :
